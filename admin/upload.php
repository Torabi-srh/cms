    ...
    if (fullPath) {
        ...
        $('#fcn').text(filename);
                                                    ...
                                                    <div class="form-group" style="text-align: center;">
                                                        <input type="file" id="file" name="file" onchange="fc()" class="inputfile" accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,text/plain, application/pdf, .docx,.xlsx,.pptx" data-multiple-caption="{count} files selected" required>  
