                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-group email-search">
                                    <input type="text" class="form-control" placeholder="Search for an email">
                                    <span class="input-group-btn">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="email-menu">
                                    <ul class="list-unstyled">
                                        <li class="active"><a href="#"><i class="icon-inbox"></i><span>Inbox</span></a></li>
                                        <li><a href="#"><i class="icon-send"></i><span>Sent</span></a></li>
                                        <li><a href="#"><i class="icon-mail_outline"></i><span>Drafts</span></a></li>
                                        <li><a href="#"><i class="icon-error"></i><span>Spam</span></a></li>
                                        <li class="divider"></li>
                                        <li><a href="#"><i class="icon-delete"></i><span>Trash</span></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-7">
                                <div class="email-actions">
                                    ...
                                    <a href="#" class="btn btn-default">Mark as read</a>
                                    <a href="#" class="btn btn-danger">Delete</a>
                                </div>
                                <div class="email">
                                    <div class="email-header">
                                        <div class="email-title"><p>Maecenas porttitor porta erat ac suscipit porta erat ac suscipit</p></div>
                                        <span class="divider"></span>
                                        <div class="email-author">
                                            <img src="http://via.placeholder.com/35x35" alt="">
                                            <span class="author-name">kenny.high@space.com</span>
                                    ...
                                    <div class="email-body">
                                        <span>
                                            ...
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ut ante id elit molestie ornare. Pellentesque porttitor facilisis risus, sit amet semper ante efficitur et. Etiam quis rutrum leo, vitae posuere augue. Donec odio leo, dapibus id sollicitudin vel, luctus sit amet justo. Aenean cursus, tellus ut consectetur commodo, est dolor fringilla mauris, nec tristique magna orci in diam. Cras eget libero sit amet felis tincidunt mattis.<br><br>
