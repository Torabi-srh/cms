...
<html lang="en">
    ...
    <body class="error-page">
                ...
                <div id="main-wrapper" class="container">
                    <div class="row">
                        <div class="col-md-6 center">
                            ...
                            <!-- <a href="/admin" class="btn btn-primary m-b-xxs">Help Center</a> -->
                            <a href="/admin" class="btn btn-default m-b-xxs">Return Home</a>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
            </div><!-- /Page Inner -->
        ...
        <!-- Javascripts -->
        <script src="/admin/assets/plugins/jquery/jquery-3.1.0.min.js"></script>
        <script src="/admin/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
        <script src="/admin/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js"></script>
        <script src="/admin/assets/plugins/uniform/js/jquery.uniform.standalone.js"></script>
        <script src="/admin/assets/plugins/switchery/switchery.min.js"></script>
        <script src="/admin/assets/js/space.min.js"></script>
    </body>
</html>